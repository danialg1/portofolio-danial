...
async function run() {
    await fetchWikiImage('commons', 'Logo-Tut-Wuri-Handayani-PNG-Warna.png', 'public/logos/sd.png');
    await fetchWikiImage('commons', 'Logo-Tut-Wuri-Handayani-PNG-Warna.png', 'public/logos/smp.png');
}
run();
